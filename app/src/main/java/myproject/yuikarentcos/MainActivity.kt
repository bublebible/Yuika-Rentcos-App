...
fun SplashScreen() {
    ...
    Box(
        ...
        Column(
            ...
            // --- LOGO CUSTOM (TANPA LINGKARAN PUTIH) ---
            Icon(
                ...
                // PENTING: Pakai Unspecified biar warna asli gambar muncul
                tint = Color.Unspecified,

                modifier = Modifier
                    .scale(scale.value) // Animasi membesar
                    .size(150.dp)       // Ukuran logo disesuaikan (agak besar biar jelas)
            )
